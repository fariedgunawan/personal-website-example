export const translations = {
  en: {
    ...
    faq: {
      ...
      q1: "How do you decide which problems to solve first?",
      a1: "We map opportunities across impact, feasibility, and effort, then prototype the riskiest assumption within 72 hours to make sure we are shipping momentum, not guesswork.",
      q2: "What does collaboration look like once we start?",
      a2: "A dedicated trio of design, engineering, and strategy meets daily in a shared async dashboard. Decisions are recorded in-line, so the team, stakeholders, and audit trail stay perfectly aligned.",
      q3: "Can you adapt to an existing design system or stack?",
      a3: "Yes. We map tokens, components, and build steps into our pipeline on day one. If a gap appears, we patch the system with regression tests so velocity never compromises fidelity.",
      q4: "How is quality validated before release?",
      a4: "Accessibility sweeps, automated visual diffs, and performance budgets run on every merge. We ship only after the experience hits the expected thresholds on real devices."
    },
    contact: {
      label: "Let's Connect",
      title1: "Let's build ",
  ...
  id: {
    ...
    faq: {
      ...
      q1: "Bagaimana Anda memutuskan masalah mana yang harus diselesaikan lebih dulu?",
      a1: "Kami memetakan peluang berdasarkan dampak, kelayakan, dan upaya, kemudian membuat prototipe asumsi yang paling berisiko dalam 72 jam untuk memastikan kami mengirimkan momentum, bukan tebakan.",
      q2: "Seperti apa kolaborasi setelah kita mulai?",
      a2: "Trio khusus dari desain, rekayasa, dan strategi bertemu setiap hari di dasbor asinkron bersama. Keputusan dicatat sejalan, sehingga tim, pemangku kepentingan, dan jejak audit tetap selaras.",
      q3: "Dapatkah Anda beradaptasi dengan sistem desain atau tumpukan yang ada?",
      a3: "Ya. Kami memetakan token, komponen, dan langkah-langkah pembangunan ke dalam pipa kami pada hari pertama. Jika celah muncul, kami menambal sistem dengan pengujian regresi sehingga kecepatan tidak pernah mengorbankan kualitas.",
      q4: "Bagaimana kualitas divalidasi sebelum rilis?",
      a4: "Pemindaian aksesibilitas, perbedaan visual otomatis, dan anggaran kinerja berjalan pada setiap penggabungan. Kami hanya mengirim setelah pengalaman mencapai ambang batas yang diharapkan pada perangkat asli."
    },
    contact: {
